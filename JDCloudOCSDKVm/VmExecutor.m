...
/// 查询镜像共享帐户列表，只允许操作您的个人私有镜像。
   /// 
@implementation  VmDescribeImageMembersExecutor

-(id) initWithJDCloudClient:(VmClient*)JDCloudClient
{
    self.jdCloudClient = JDCloudClient;
    self.method = @"GET";
    self.url = @"/regions/{regionId}/images/{imageId}/members";
    return self;
}
@end
...
/// 创建一台或多台指定配置的云主机，创建模式分为三种：1.普通方式、2.使用高可用组、3.使用启动模板。三种方式创建云主机时参数的必传与非必传是不同的，具体请参考&lt;a href&#x3D;&quot;http://docs.jdcloud.com/virtual-machines/api/create_vm_sample&quot;&gt;参数详细说明&lt;/a&gt;&lt;br&gt;
   ...
   /// 
@implementation  VmCreateInstancesExecutor
...
/// 共享镜像，只允许操作您的个人私有镜像，单个镜像最多可共享给20个京东云帐户。&lt;br&gt;
   /// 整机镜像目前不支持共享。
   /// 
@implementation  VmShareImageExecutor

-(id) initWithJDCloudClient:(VmClient*)JDCloudClient
{
    self.jdCloudClient = JDCloudClient;
    self.method = @"POST";
    self.url = @"/regions/{regionId}/images/{imageId}:share";
    return self;
}
@end
...
/// 启动单个云主机，只能启动&lt;b&gt;stopped&lt;/b&gt;状态的云主机，云主机没有正在进行中的任务才可启动。&lt;br&gt;
   ...
   /// 
@implementation  VmStartInstanceExecutor

-(id) initWithJDCloudClient:(VmClient*)JDCloudClient
{
    self.jdCloudClient = JDCloudClient;
    self.method = @"POST";
    self.url = @"/regions/{regionId}/instances/{instanceId}:startInstance";
    return self;
}
@end
...
/// 撤销社区镜像，只允许操作您的个人私有镜像。
   /// 
@implementation  VmUnReleaseImageExecutor

-(id) initWithJDCloudClient:(VmClient*)JDCloudClient
{
    self.jdCloudClient = JDCloudClient;
    self.method = @"POST";
    self.url = @"/regions/{regionId}/images/{imageId}:unrelease";
    return self;
}
@end
...
/// 取消共享镜像，只允许操作您的个人私有镜像。
   /// 
@implementation  VmUnShareImageExecutor

-(id) initWithJDCloudClient:(VmClient*)JDCloudClient
{
    self.jdCloudClient = JDCloudClient;
    self.method = @"POST";
    self.url = @"/regions/{regionId}/images/{imageId}:unshare";
    return self;
}
@end
...
/// 批量查询镜像的实例规格限制。&lt;br&gt;
   ...
   /// 
@implementation  VmDescribeImageConstraintsBatchExecutor

-(id) initWithJDCloudClient:(VmClient*)JDCloudClient
{
    self.jdCloudClient = JDCloudClient;
    self.method = @"GET";
    self.url = @"/regions/{regionId}/imageConstraints";
    return self;
}
@end
...
/// 修改一个启动模板的信息，包括名称、描述
   /// 
@implementation  VmUpdateInstanceTemplateExecutor

-(id) initWithJDCloudClient:(VmClient*)JDCloudClient
{
    self.jdCloudClient = JDCloudClient;
    self.method = @"PATCH";
    self.url = @"/regions/{regionId}/instanceTemplates/{instanceTemplateId}";
    return self;
}
@end
...
/// 为一台云主机挂载一块云硬盘，云主机和云硬盘没有正在进行中的的任务时才可挂载。&lt;br&gt;
   ...
   /// 
@implementation  VmAttachDiskExecutor

-(id) initWithJDCloudClient:(VmClient*)JDCloudClient
{
    self.jdCloudClient = JDCloudClient;
    self.method = @"POST";
    self.url = @"/regions/{regionId}/instances/{instanceId}:attachDisk";
    return self;
}
@end
...
/// 修改云主机密码，主机没有正在进行中的任务时才可操作。&lt;br&gt;
   /// 修改密码后，需要重启云主机后生效。
   /// 
@implementation  VmModifyInstancePasswordExecutor

-(id) initWithJDCloudClient:(VmClient*)JDCloudClient
{
    self.jdCloudClient = JDCloudClient;
    self.method = @"POST";
    self.url = @"/regions/{regionId}/instances/{instanceId}:modifyInstancePassword";
    return self;
}
@end
...
/// 云主机绑定一块弹性网卡。&lt;br&gt;
   ...
   /// 弹性网卡与云主机必须在相同vpc下。
   /// 
@implementation  VmAttachNetworkInterfaceExecutor

-(id) initWithJDCloudClient:(VmClient*)JDCloudClient
{
    self.jdCloudClient = JDCloudClient;
    self.method = @"POST";
    self.url = @"/regions/{regionId}/instances/{instanceId}:attachNetworkInterface";
    return self;
}
@end
...
/// 删除ssh密钥对。
   /// 
@implementation  VmDeleteKeypairExecutor

-(id) initWithJDCloudClient:(VmClient*)JDCloudClient
{
    self.jdCloudClient = JDCloudClient;
    self.method = @"DELETE";
    self.url = @"/regions/{regionId}/keypairs/{keyName}";
    return self;
}
@end
...
/// 查询镜像详情。
   /// 
@implementation  VmDescribeImageExecutor

-(id) initWithJDCloudClient:(VmClient*)JDCloudClient
{
    self.jdCloudClient = JDCloudClient;
    self.method = @"GET";
    self.url = @"/regions/{regionId}/images/{imageId}";
    return self;
}
@end
...
/// 导入由其他工具生成的密钥对的公钥部分。&lt;br&gt;
   /// 若传入已存在的密钥名称，会返回错误。
   /// 
@implementation  VmImportKeypairExecutor

-(id) initWithJDCloudClient:(VmClient*)JDCloudClient
{
    self.jdCloudClient = JDCloudClient;
    self.method = @"POST";
    self.url = @"/regions/{regionId}/keypairs:import";
    return self;
}
@end
...
/// 查询一台云主机的详细信息
   /// 
@implementation  VmDescribeInstanceExecutor
...
/// 镜像跨区复制，将私有镜像复制到其它地域下，只允许操作您的个人私有镜像。&lt;br&gt;
   ...
   /// 
@implementation  VmCopyImagesExecutor

-(id) initWithJDCloudClient:(VmClient*)JDCloudClient
{
    self.jdCloudClient = JDCloudClient;
    self.method = @"POST";
    self.url = @"/regions/{regionId}/images:copyImages";
    return self;
}
@end
...
/// 查询配额，支持的类型：云主机、镜像、密钥、模板、镜像共享。
   /// 
@implementation  VmDescribeQuotasExecutor
...
/// 修改虚机弹性网卡属性，包括是否随云主机一起删除。&lt;br&gt;
   /// 不能修改主网卡。
   /// 
@implementation  VmModifyInstanceNetworkAttributeExecutor

-(id) initWithJDCloudClient:(VmClient*)JDCloudClient
{
    self.jdCloudClient = JDCloudClient;
    self.method = @"POST";
    self.url = @"/regions/{regionId}/instances/{instanceId}:modifyInstanceNetworkAttribute";
    return self;
}
@end
...
/// 修改镜像信息，包括名称、描述；只允许操作您的个人私有镜像。
   /// 
@implementation  VmModifyImageAttributeExecutor

-(id) initWithJDCloudClient:(VmClient*)JDCloudClient
{
    self.jdCloudClient = JDCloudClient;
    self.method = @"POST";
    self.url = @"/regions/{regionId}/images/{imageId}:modifyImageAttribute";
    return self;
}
@end
...
/// 重启单个云主机，只能重启&lt;b&gt;running&lt;/b&gt;状态的云主机，云主机没有正在进行中的任务才可重启。
   /// 
@implementation  VmRebootInstanceExecutor
...
/// 批量查询密钥对。&lt;br&gt;
   /// 此接口支持分页查询，默认每页20条。
   /// 
@implementation  VmDescribeKeypairsExecutor

-(id) initWithJDCloudClient:(VmClient*)JDCloudClient
{
    self.jdCloudClient = JDCloudClient;
    self.method = @"GET";
    self.url = @"/regions/{regionId}/keypairs";
    return self;
}
@end
...
/// 云主机缷载云硬盘，云主机和云硬盘没有正在进行中的任务时才可缷载。&lt;br&gt;
   /// 
@implementation  VmDetachDiskExecutor

-(id) initWithJDCloudClient:(VmClient*)JDCloudClient
{
    self.jdCloudClient = JDCloudClient;
    self.method = @"POST";
    self.url = @"/regions/{regionId}/instances/{instanceId}:detachDisk";
    return self;
}
@end
...
/// 导入镜像，将外部镜像导入到京东云中
   /// 
@implementation  VmImportImageExecutor

-(id) initWithJDCloudClient:(VmClient*)JDCloudClient
{
    self.jdCloudClient = JDCloudClient;
    self.method = @"POST";
    self.url = @"/regions/{regionId}/images:import";
    return self;
}
@end
...
/// 创建一个指定参数的启动模板，启动模板中包含创建云主机时的大部分配置参数，避免每次创建云主机时的重复性工作。&lt;br&gt;
   ...
   /// 
@implementation  VmCreateInstanceTemplateExecutor

-(id) initWithJDCloudClient:(VmClient*)JDCloudClient
{
    self.jdCloudClient = JDCloudClient;
    self.method = @"POST";
    self.url = @"/regions/{regionId}/instanceTemplates";
    return self;
}
@end
...
/// 为云主机创建私有镜像。云主机状态必须为&lt;b&gt;stopped&lt;/b&gt;。&lt;br&gt;
   ...
   /// 
@implementation  VmCreateImageExecutor

-(id) initWithJDCloudClient:(VmClient*)JDCloudClient
{
    self.jdCloudClient = JDCloudClient;
    self.method = @"POST";
    self.url = @"/regions/{regionId}/instances/{instanceId}:createImage";
    return self;
}
@end
...
/// 为云主机主网卡的主内网IP绑定弹性公网IP。&lt;br&gt;
   ...
   /// 
@implementation  VmAssociateElasticIpExecutor

-(id) initWithJDCloudClient:(VmClient*)JDCloudClient
{
    self.jdCloudClient = JDCloudClient;
    self.method = @"POST";
    self.url = @"/regions/{regionId}/instances/{instanceId}:associateElasticIp";
    return self;
}
@end
...
/// 云主机解绑弹性公网IP，解绑的是主网卡、内网主IP对应的弹性公网IP。
   /// 
@implementation  VmDisassociateElasticIpExecutor

-(id) initWithJDCloudClient:(VmClient*)JDCloudClient
{
    self.jdCloudClient = JDCloudClient;
    self.method = @"POST";
    self.url = @"/regions/{regionId}/instances/{instanceId}:disassociateElasticIp";
    return self;
}
@end
...
/// 停止单个云主机，只能停止&lt;b&gt;running&lt;/b&gt;状态的云主机，云主机没有正在进行中的任务才可停止
   /// 
@implementation  VmStopInstanceExecutor

-(id) initWithJDCloudClient:(VmClient*)JDCloudClient
{
    self.jdCloudClient = JDCloudClient;
    self.method = @"POST";
    self.url = @"/regions/{regionId}/instances/{instanceId}:stopInstance";
    return self;
}
@end
...
/// 查询启动模板详情
   /// 
@implementation  VmDescribeInstanceTemplateExecutor
...
/// 查询镜像信息列表。&lt;br&gt;
   ...
   /// 此接口支持分页查询，默认每页20条。
   /// 
@implementation  VmDescribeImagesExecutor
...
/// 获取云主机vnc，用于连接管理云主机。&lt;br&gt;
   ...
   /// 
@implementation  VmDescribeInstanceVncUrlExecutor

-(id) initWithJDCloudClient:(VmClient*)JDCloudClient
{
    self.jdCloudClient = JDCloudClient;
    self.method = @"GET";
    self.url = @"/regions/{regionId}/instances/{instanceId}/vnc";
    return self;
}
@end
...
/// 查询镜像的实例规格限制。&lt;br&gt;
   /// 通过此接口可以查看镜像不支持的实例规格。只有官方镜像、第三方镜像有实例规格的限制，个人的私有镜像没有此限制。
   /// 
@implementation  VmDescribeImageConstraintsExecutor

-(id) initWithJDCloudClient:(VmClient*)JDCloudClient
{
    self.jdCloudClient = JDCloudClient;
    self.method = @"GET";
    self.url = @"/regions/{regionId}/images/{imageId}/constraints";
    return self;
}
@end
...
/// 云主机使用指定镜像重置云主机系统&lt;br&gt;
   ...
   /// 
@implementation  VmRebuildInstanceExecutor

-(id) initWithJDCloudClient:(VmClient*)JDCloudClient
{
    self.jdCloudClient = JDCloudClient;
    self.method = @"POST";
    self.url = @"/regions/{regionId}/instances/{instanceId}:rebuildInstance";
    return self;
}
@end
...
/// 修改云主机部分信息，包括名称、描述。
   /// 
@implementation  VmModifyInstanceAttributeExecutor

-(id) initWithJDCloudClient:(VmClient*)JDCloudClient
{
    self.jdCloudClient = JDCloudClient;
    self.method = @"POST";
    self.url = @"/regions/{regionId}/instances/{instanceId}:modifyInstanceAttribute";
    return self;
}
@end
...
/// 云主机变更实例规格&lt;br&gt;
   ...
   /// 云主机欠费或到期时，无法更改实例规格。
   /// 
@implementation  VmResizeInstanceExecutor

-(id) initWithJDCloudClient:(VmClient*)JDCloudClient
{
    self.jdCloudClient = JDCloudClient;
    self.method = @"POST";
    self.url = @"/regions/{regionId}/instances/{instanceId}:resizeInstance";
    return self;
}
@end
...
/// 发布社区镜像，只允许操作您的个人私有镜像。发布为社区镜像后会撤销共享关系。&lt;br&gt;
   /// 
@implementation  VmReleaseImageExecutor

-(id) initWithJDCloudClient:(VmClient*)JDCloudClient
{
    self.jdCloudClient = JDCloudClient;
    self.method = @"POST";
    self.url = @"/regions/{regionId}/images/{imageId}:release";
    return self;
}
@end
...
/// 删除一个私有镜像，只允许操作您的个人私有镜像。&lt;br&gt;
   ...
   /// 
@implementation  VmDeleteImageExecutor
...
/// 查询实例规格信息列表
   /// 
@implementation  VmDescribeInstanceTypesExecutor
...
/// 删除一个启动模板
   /// 
@implementation  VmDeleteInstanceTemplateExecutor
...
/// 云主机缷载一块弹性网卡。&lt;br&gt;
   ...
   /// 不能缷载主网卡。
   /// 
@implementation  VmDetachNetworkInterfaceExecutor

-(id) initWithJDCloudClient:(VmClient*)JDCloudClient
{
    self.jdCloudClient = JDCloudClient;
    self.method = @"POST";
    self.url = @"/regions/{regionId}/instances/{instanceId}:detachNetworkInterface";
    return self;
}
@end
...
/// 查询启动模板列表
   /// 
@implementation  VmDescribeInstanceTemplatesExecutor
...
/// 修改云主机挂载的数据盘属性，包括是否随主机删除。&lt;br&gt;
   ...
   /// 
@implementation  VmModifyInstanceDiskAttributeExecutor

-(id) initWithJDCloudClient:(VmClient*)JDCloudClient
{
    self.jdCloudClient = JDCloudClient;
    self.method = @"POST";
    self.url = @"/regions/{regionId}/instances/{instanceId}:modifyInstanceDiskAttribute";
    return self;
}
@end

/// 批量查询云主机内网IP地址，查询的是主网卡内网主IP地址。
@implementation  VmDescribeInstancePrivateIpAddressExecutor

-(id) initWithJDCloudClient:(VmClient*)JDCloudClient
{
    self.jdCloudClient = JDCloudClient;
    self.method = @"GET";
    self.url = @"/regions/{regionId}/instancePrivateIpAddress";
    return self;
}
@end
...
/// 查询镜像导入任务详情
   /// 
@implementation  VmImageTasksExecutor

-(id) initWithJDCloudClient:(VmClient*)JDCloudClient
{
    self.jdCloudClient = JDCloudClient;
    self.method = @"GET";
    self.url = @"/regions/{regionId}/imageTasks";
    return self;
}
@end

/// 批量查询云主机状态
@implementation  VmDescribeInstanceStatusExecutor

-(id) initWithJDCloudClient:(VmClient*)JDCloudClient
{
    self.jdCloudClient = JDCloudClient;
    self.method = @"GET";
    self.url = @"/regions/{regionId}/instanceStatus";
    return self;
}
@end
...
/// 删除按配置计费、或包年包月已到期的单个云主机。不能删除没有计费信息的云主机。&lt;br&gt;
   ...
   ///  [MFA enabled]
@implementation  VmDeleteInstanceExecutor
...
/// 创建ssh密钥对。公钥部分存储在京东云，并返回未加密的 PEM 编码的 PKCS#8 格式私钥，您只有一次机会保存您的私钥。请妥善保管。&lt;br&gt;
   /// 若传入已存在的密钥名称，会返回错误。
   /// 
@implementation  VmCreateKeypairExecutor
...
/// 批量查询云主机的详细信息&lt;br&gt;
   /// 此接口支持分页查询，默认每页20条。
   /// 
@implementation  VmDescribeInstancesExecutor
...
/// 校验启动模板的有效性
   /// 
@implementation  VmVerifyInstanceTemplateExecutor

-(id) initWithJDCloudClient:(VmClient*)JDCloudClient
{
    self.jdCloudClient = JDCloudClient;
    self.method = @"GET";
    self.url = @"/regions/{regionId}/instanceTemplates/{instanceTemplateId}:verify";
    return self;
}
@end

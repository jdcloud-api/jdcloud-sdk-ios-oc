...
-(id) initWithDic:(NSDictionary*)dictionary{
     self.startTime = [dictionary objectForKey:@"startTime"];
     self.endTime = [dictionary objectForKey:@"endTime"];
     self.data = [[LiveStatisticGroupByStreamResultData alloc]initWithDic:[dictionary objectForKey:@"data"]];
     return self;
}
-(id) initWithStartTime:(NSString*) startTime
                    endTime:(NSString*)endTime
...
-(id) initWithDic:(NSDictionary*)dictionary{
     self.startTime = [dictionary objectForKey:@"startTime"];
     self.endTime = [dictionary objectForKey:@"endTime"];
     self.data = [[LiveStatisticGroupByAreaResultData alloc]initWithDic:[dictionary objectForKey:@"data"]];
     return self;
}
-(id) initWithStartTime:(NSString*) startTime
                    endTime:(NSString*)endTime
...
@implementation PublishStreamInfoResult : NSObject
-(NSMutableDictionary*) dictionary{
     NSMutableDictionary* result = [[NSMutableDictionary alloc] init];
       if([self startTime])
       {
...
@implementation RankingUrlResult : NSObject
-(NSMutableDictionary*) dictionary{
    NSMutableDictionary* result = [[NSMutableDictionary alloc] init];
    NSMutableArray<NSDictionary*>* arrayDic  = [[NSMutableArray alloc] init];
     for (int i =0 ; i< [[self rankingList] count]; i++) {
           DomainsLogResultData* item = [[self rankingList] objectAtIndex:i];
           [arrayDic addObject:[item dictionary]];
     }

...
#ifndef PodExecutor_h
#define PodExecutor_h
#import <JDCloudOCSDKPod/PodClient.h>

///  查询资源的配额，支持：原生容器 pod 和 secret.
   /// 
@interface PodDescribeQuotaExecutor : JDCloudExecutor

-(id) initWithJDCloudClient:(PodClient*)JDCloudClient;
@end
///  获取 pod 中某个容器的详情
@interface PodDescribeContainerExecutor : JDCloudExecutor
...
///  查询 secret 列表。&lt;br&gt; 
   /// 此接口支持分页查询，默认每页20条。
   /// 
@interface PodDescribeSecretsExecutor : JDCloudExecutor

-(id) initWithJDCloudClient:(PodClient*)JDCloudClient;
@end
///  创建一个 secret，用于存放镜像仓库机密相关信息。
   /// 
@interface PodCreateSecretExecutor : JDCloudExecutor

-(id) initWithJDCloudClient:(PodClient*)JDCloudClient;
@end
///  查询单个 secret 详情
   /// 
@interface PodDescribeSecretExecutor : JDCloudExecutor

-(id) initWithJDCloudClient:(PodClient*)JDCloudClient;
@end
///  pod 解绑公网 IP，解绑的是主网卡、主内网 IP 对应的弹性 IP.
   /// 
@interface PodDisassociateElasticIpExecutor : JDCloudExecutor

-(id) initWithJDCloudClient:(PodClient*)JDCloudClient;
@end
///  设置TTY大小
@interface PodResizeTTYExecutor : JDCloudExecutor

-(id) initWithJDCloudClient:(PodClient*)JDCloudClient;
@end
///  将容器连接到本地标准输入输出
   /// 
@interface PodAttachExecutor : JDCloudExecutor

-(id) initWithJDCloudClient:(PodClient*)JDCloudClient;
@end
///  执行exec，此接口需要升级Http协议到WebSocket
@interface PodExecStartExecutor : JDCloudExecutor
...
///  启动处于关闭状态的单个 pod ，处在任务执行中的 pod 无法启动。&lt;br&gt;
   ...
   /// 
@interface PodStartPodExecutor : JDCloudExecutor
...
///  批量查询 pod 的详细信息&lt;br&gt;
   /// 此接口支持分页查询，默认每页20条。
   /// 
@interface PodDescribePodsExecutor : JDCloudExecutor

-(id) initWithJDCloudClient:(PodClient*)JDCloudClient;
@end
///  获取exec退出码
@interface PodExecGetExitCodeExecutor : JDCloudExecutor
...
///  创建一台或多台 pod
   ...
   /// 
@interface PodCreatePodsExecutor : JDCloudExecutor

-(id) initWithJDCloudClient:(PodClient*)JDCloudClient;
@end
///  podName 是否符合命名规范，以及查询指定 podName 区域内是否已经存在。
   /// 
@interface PodCheckPodNameExecutor : JDCloudExecutor

-(id) initWithJDCloudClient:(PodClient*)JDCloudClient;
@end
///  查询单个容器日志
   /// 
@interface PodGetContainerLogsExecutor : JDCloudExecutor

-(id) initWithJDCloudClient:(PodClient*)JDCloudClient;
@end
///  查询实例规格信息列表
   /// 
@interface PodDescribeInstanceTypesExecutor : JDCloudExecutor

-(id) initWithJDCloudClient:(PodClient*)JDCloudClient;
@end
///  修改 pod 的描述。
   /// 
@interface PodModifyPodAttributeExecutor : JDCloudExecutor
...
///  pod 状态必须为 stopped、running 或 error状态。 &lt;br&gt;
   ...
   ///  [MFA enabled]
@interface PodDeletePodExecutor : JDCloudExecutor

-(id) initWithJDCloudClient:(PodClient*)JDCloudClient;
@end
///  对 pod 中的容器使用新的镜像进行重置，pod 需要处于关闭状态。
   /// 
@interface PodRebuildPodExecutor : JDCloudExecutor
...
///  pod 绑定弹性公网 IP，绑定的是主网卡、主内网IP对应的弹性IP. &lt;br&gt;
   ...
   /// 如果是黑名单中的用户，会返回错误。
   /// 
@interface PodAssociateElasticIpExecutor : JDCloudExecutor
...
///  调整pod实例类型配置。
   ...
   /// 
@interface PodResizePodExecutor : JDCloudExecutor

-(id) initWithJDCloudClient:(PodClient*)JDCloudClient;
@end
///  创建 exec
   /// 
@interface PodExecCreateExecutor : JDCloudExecutor

-(id) initWithJDCloudClient:(PodClient*)JDCloudClient;
@end
///  停止处于运行状态的单个实例，处于任务执行中的 pod 无法启动。
   /// 
@interface PodStopPodExecutor : JDCloudExecutor

-(id) initWithJDCloudClient:(PodClient*)JDCloudClient;
@end
///  查询一个 pod 的详细信息
   /// 
@interface PodDescribePodExecutor : JDCloudExecutor

-(id) initWithJDCloudClient:(PodClient*)JDCloudClient;
@end
///  删除单个 secret
   /// 
@interface PodDeleteSecretExecutor : JDCloudExecutor

...
#import <JDCloudOCSDKDatastar/DatastarExecutor.h>

@implementation DatastarClient
...
-(id)initWithGlobalConfig{
    ...
    {
        self.sdkEnvironment = [[SDKEnvironment alloc] initWithEndPoint:@"datastar.cn-south-1.jdcloud-api.com"];
    }else
    {
        self.sdkEnvironment = [GlobalConfig sdkEnvironment];
    }
    self.httpRequestProtocol = @"https";
    _userAgent = @"JdCloudOCSdk 0.0.1 datastar  v1";
    _serviceName = @"datastar";
    _version = @"v1";
...
{
DatastarGetLargeScreenDataExecutor* excutor = [[DatastarGetLargeScreenDataExecutor alloc] initWithJDCloudClient:self];
    ...
    if(responseResult)
    {
        ...
        if(resultData)
        {
            ...
            {
                @try {
                    DatastarGetLargeScreenDataResponse* response = [[DatastarGetLargeScreenDataResponse alloc]initWithDic:allKeys];
                    if(response)
                    {

...
#ifndef NativecontainerModel_h
#define NativecontainerModel_h
...
-(id) initWithDic:(NSDictionary*)dictionary;                    
@end
@interface NativecontainerQuota :NSObject
...
-(id) initWithDic:(NSDictionary*)dictionary;                    
@end
@interface NativecontainerTagFilter :NSObject

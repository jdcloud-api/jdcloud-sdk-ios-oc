...
+(NSData*) compressData: (NSData*)uncompressedData  {
        ...
        
    {
        ...
        NSString* errorInfo = [[@"Error: " stringByAppendingString:errorMsg] stringByAppendingFormat:@"%s", zlibStreamStruct.msg];
        NSException *e = [SDKArgumentNullException exceptionWithName:@"GzipErrorException" reason:errorInfo userInfo:nil];
        @throw e;

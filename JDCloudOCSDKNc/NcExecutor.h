...
#ifndef NcExecutor_h
#define NcExecutor_h
#import <JDCloudOCSDKNc/NcClient.h>

///  容器绑定弹性公网 IP，绑定的是主网卡、主内网IP对应的弹性IP. &lt;br&gt;
   /// 一台云主机只能绑定一个弹性公网 IP(主网卡)，若主网卡已存在弹性公网IP，会返回错误。&lt;br&gt;
   /// 如果是黑名单中的用户，会返回错误。
   /// 
@interface NcAssociateElasticIpExecutor : JDCloudExecutor

-(id) initWithJDCloudClient:(NcClient*)JDCloudClient;
@end
///  查询单个 secret 详情
   /// 
@interface NcDescribeSecretExecutor : JDCloudExecutor

-(id) initWithJDCloudClient:(NcClient*)JDCloudClient;
@end
///  创建一个 secret，用于存放镜像仓库机密相关信息。
   /// 
@interface NcCreateSecretExecutor : JDCloudExecutor

-(id) initWithJDCloudClient:(NcClient*)JDCloudClient;
@end
///  修改容器的 名称 和 描述。
   /// 
@interface NcModifyContainerAttributeExecutor : JDCloudExecutor

-(id) initWithJDCloudClient:(NcClient*)JDCloudClient;
@end
///  删除单个 secret
   /// 
@interface NcDeleteSecretExecutor : JDCloudExecutor

-(id) initWithJDCloudClient:(NcClient*)JDCloudClient;
@end
///  容器解绑公网 IP，解绑的是主网卡、主内网 IP 对应的弹性 IP.
   /// 
@interface NcDisassociateElasticIpExecutor : JDCloudExecutor
...
///  容器状态必须为 stopped、running 或 error状态。 &lt;br&gt;
   ...
   /// 
@interface NcDeleteContainerExecutor : JDCloudExecutor

-(id) initWithJDCloudClient:(NcClient*)JDCloudClient;
@end
///  查询一台原生容器的详细信息
   /// 
@interface NcDescribeContainerExecutor : JDCloudExecutor
...
///  启动处于关闭状态的单个容器，处在任务执行中的容器无法启动。&lt;br&gt;
   ...
   /// 
@interface NcStartContainerExecutor : JDCloudExecutor
...
///  批量查询原生容器的详细信息&lt;br&gt;
   /// 此接口支持分页查询，默认每页20条。
   /// 
@interface NcDescribeContainersExecutor : JDCloudExecutor

-(id) initWithJDCloudClient:(NcClient*)JDCloudClient;
@end
///  查询单个容器日志
   /// 
@interface NcGetLogsExecutor : JDCloudExecutor

-(id) initWithJDCloudClient:(NcClient*)JDCloudClient;
@end
///  查询资源的配额，支持：原生容器 pod 和 secret.
   /// 
@interface NcDescribeQuotaExecutor : JDCloudExecutor
...
///  创建一台或多台指定配置容器。
   ...
   /// 
@interface NcCreateContainersExecutor : JDCloudExecutor

-(id) initWithJDCloudClient:(NcClient*)JDCloudClient;
@end
///  停止处于运行状态的单个实例，处于任务执行中的容器无法启动。
   /// 
@interface NcStopContainerExecutor : JDCloudExecutor
...
///  查询 secret 列表。&lt;br&gt; 
   /// 此接口支持分页查询，默认每页20条。
   /// 
@interface NcDescribeSecretsExecutor : JDCloudExecutor

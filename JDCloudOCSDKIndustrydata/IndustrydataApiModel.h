...
#ifndef IndustrydataApiModel_h
#define IndustrydataApiModel_h
#import <JDCloudOCSDKCore/JDCloudOCSDKCore.h>
#import <JDCloudOCSDKIndustrydata/IndustrydataModel.h>


@interface IndustrydataGetLargeScreenDataResult : NSObject
/// true为成功，false为失败
...
@interface IndustrydataGetLargeScreenDataResponse : NSObject

@property NSString* requestId;

@property ServiceError* error;

@property IndustrydataGetLargeScreenDataResult* result;
...
@interface IndustrydataGetLargeScreenDataRequest:JDCloudRequest

...
#ifndef IotcoreModel_h
#define IotcoreModel_h
...
-(id) initWithDic:(NSDictionary*)dictionary;                    
@end
@interface ThingServiceMsg :NSObject
...
-(id) initWithDic:(NSDictionary*)dictionary;                    
@end
@interface ThingServiceParam :NSObject
...
-(id) initWithDic:(NSDictionary*)dictionary;                    
@end
@interface MonitorIotCoreInstance :NSObject
...
/// 规格
@property (strong,nonatomic,nonnull)  NSString*  specifications;

/// 实例状态[0-创建中，1-运行中，2-停止]
@property (strong,nonatomic,nonnull)  NSString*  instanceStatus;

/// 描述
@property (strong,nonatomic,nonnull)  NSString*  instanceDescription;

/// 资源到期时间
@property (strong,nonatomic,nonnull)  NSNumber*  expiredTime;
...
/// 最大同时在线设备数
@property (strong,nonatomic,nonnull)  NSNumber*  maxOnlineDevices;

/// 每月最大消息数
@property (strong,nonatomic,nonnull)  NSNumber*  maxMonthMessages;
...
/// 输入参数
@property (strong,nonatomic,nonnull)  NSArray<ProductProperty*>*  input;

/// 输出参数
@property (strong,nonatomic,nonnull)  NSArray<ProductProperty*>*  output;

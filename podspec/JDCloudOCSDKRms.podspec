...
s.name         = "JDCloudOCSDKRms"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Rms"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Rms framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKRms", "JDCloudOCSDKRms/**/*.{h,m}"


s.public_header_files = "JDCloudSDKRms/*.h"

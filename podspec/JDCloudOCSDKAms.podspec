...
s.name         = "JDCloudOCSDKAms"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Ams"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Ams framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKAms", "JDCloudOCSDKAms/**/*.{h,m}"


s.public_header_files = "JDCloudSDKAms/*.h"

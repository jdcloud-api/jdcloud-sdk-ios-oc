...
s.name         = "JDCloudOCSDKKms"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Kms"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Kms framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKKms", "JDCloudOCSDKKms/**/*.{h,m}"


s.public_header_files = "JDCloudSDKKms/*.h"

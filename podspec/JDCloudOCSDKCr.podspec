...
s.name         = "JDCloudOCSDKCr"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Cr"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Cr framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKCr", "JDCloudOCSDKCr/**/*.{h,m}"


s.public_header_files = "JDCloudSDKCr/*.h"

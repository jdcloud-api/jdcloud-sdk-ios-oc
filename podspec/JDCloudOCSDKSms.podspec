...
s.name         = "JDCloudOCSDKSms"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Sms"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Sms framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKSms", "JDCloudOCSDKSms/**/*.{h,m}"


s.public_header_files = "JDCloudSDKSms/*.h"

...
s.name         = "JDCloudOCSDKVm"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Vm"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Vm framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKVm", "JDCloudOCSDKVm/**/*.{h,m}"


s.public_header_files = "JDCloudSDKVm/*.h"

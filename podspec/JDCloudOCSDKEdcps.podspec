...
s.name         = "JDCloudOCSDKEdcps"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Edcps"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Edcps framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKEdcps", "JDCloudOCSDKEdcps/**/*.{h,m}"


s.public_header_files = "JDCloudSDKEdcps/*.h"

...
s.name         = "JDCloudOCSDKSop"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Sop"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Sop framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKSop", "JDCloudOCSDKSop/**/*.{h,m}"


s.public_header_files = "JDCloudSDKSop/*.h"

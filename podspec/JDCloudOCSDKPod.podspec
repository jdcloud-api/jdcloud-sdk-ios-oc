...
s.name         = "JDCloudOCSDKPod"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Pod"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Pod framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKPod", "JDCloudOCSDKPod/**/*.{h,m}"


s.public_header_files = "JDCloudSDKPod/*.h"

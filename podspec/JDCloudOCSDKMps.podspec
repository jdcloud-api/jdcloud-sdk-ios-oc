...
s.name         = "JDCloudOCSDKMps"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Mps"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Mps framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKMps", "JDCloudOCSDKMps/**/*.{h,m}"


s.public_header_files = "JDCloudSDKMps/*.h"

...
s.name         = "JDCloudOCSDKVpc"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Vpc"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Vpc framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKVpc", "JDCloudOCSDKVpc/**/*.{h,m}"


s.public_header_files = "JDCloudSDKVpc/*.h"

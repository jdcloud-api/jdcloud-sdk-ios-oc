...
s.name         = "JDCloudOCSDKJke"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Jke"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Jke framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKJke", "JDCloudOCSDKJke/**/*.{h,m}"


s.public_header_files = "JDCloudSDKJke/*.h"

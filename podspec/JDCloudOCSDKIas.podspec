...
s.name         = "JDCloudOCSDKIas"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Ias"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Ias framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKIas", "JDCloudOCSDKIas/**/*.{h,m}"


s.public_header_files = "JDCloudSDKIas/*.h"

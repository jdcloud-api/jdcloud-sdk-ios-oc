...
s.name         = "JDCloudOCSDKCdn"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Cdn"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Cdn framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKCdn", "JDCloudOCSDKCdn/**/*.{h,m}"


s.public_header_files = "JDCloudSDKCdn/*.h"

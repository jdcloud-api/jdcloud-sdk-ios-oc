...
s.name         = "JDCloudOCSDKDeploy"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Deploy"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Deploy framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKDeploy", "JDCloudOCSDKDeploy/**/*.{h,m}"


s.public_header_files = "JDCloudSDKDeploy/*.h"

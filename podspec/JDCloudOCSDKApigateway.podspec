...
s.name         = "JDCloudOCSDKApigateway"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Apigateway"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Apigateway framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKApigateway", "JDCloudOCSDKApigateway/**/*.{h,m}"


s.public_header_files = "JDCloudSDKApigateway/*.h"

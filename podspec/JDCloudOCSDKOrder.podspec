...
s.name         = "JDCloudOCSDKOrder"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Order"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Order framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKOrder", "JDCloudOCSDKOrder/**/*.{h,m}"


s.public_header_files = "JDCloudSDKOrder/*.h"

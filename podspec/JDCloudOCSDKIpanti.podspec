...
s.name         = "JDCloudOCSDKIpanti"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Ipanti"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Ipanti framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKIpanti", "JDCloudOCSDKIpanti/**/*.{h,m}"


s.public_header_files = "JDCloudSDKIpanti/*.h"

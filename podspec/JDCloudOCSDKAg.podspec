...
s.name         = "JDCloudOCSDKAg"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Ag"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Ag framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKAg", "JDCloudOCSDKAg/**/*.{h,m}"


s.public_header_files = "JDCloudSDKAg/*.h"

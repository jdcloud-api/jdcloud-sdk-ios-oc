...
s.name         = "JDCloudOCSDKPipeline"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Pipeline"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Pipeline framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKPipeline", "JDCloudOCSDKPipeline/**/*.{h,m}"


s.public_header_files = "JDCloudSDKPipeline/*.h"

...
s.name         = "JDCloudOCSDKElite"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Elite"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Elite framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKElite", "JDCloudOCSDKElite/**/*.{h,m}"


s.public_header_files = "JDCloudSDKElite/*.h"

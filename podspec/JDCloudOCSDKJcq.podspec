...
s.name         = "JDCloudOCSDKJcq"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Jcq"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Jcq framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKJcq", "JDCloudOCSDKJcq/**/*.{h,m}"


s.public_header_files = "JDCloudSDKJcq/*.h"

...
s.name         = "JDCloudOCSDKNativecontainer"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Nativecontainer"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Nativecontainer framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKNativecontainer", "JDCloudOCSDKNativecontainer/**/*.{h,m}"


s.public_header_files = "JDCloudSDKNativecontainer/*.h"

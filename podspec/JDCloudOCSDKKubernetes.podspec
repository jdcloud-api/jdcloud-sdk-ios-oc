...
s.name         = "JDCloudOCSDKKubernetes"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Kubernetes"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Kubernetes framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKKubernetes", "JDCloudOCSDKKubernetes/**/*.{h,m}"


s.public_header_files = "JDCloudSDKKubernetes/*.h"

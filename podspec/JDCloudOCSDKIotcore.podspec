...
s.name         = "JDCloudOCSDKIotcore"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Iotcore"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Iotcore framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKIotcore", "JDCloudOCSDKIotcore/**/*.{h,m}"


s.public_header_files = "JDCloudSDKIotcore/*.h"

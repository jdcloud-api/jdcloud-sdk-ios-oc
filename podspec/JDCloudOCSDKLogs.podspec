...
s.name         = "JDCloudOCSDKLogs"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Logs"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Logs framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKLogs", "JDCloudOCSDKLogs/**/*.{h,m}"


s.public_header_files = "JDCloudSDKLogs/*.h"

...
s.name         = "JDCloudOCSDKAntipro"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Antipro"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Antipro framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKAntipro", "JDCloudOCSDKAntipro/**/*.{h,m}"


s.public_header_files = "JDCloudSDKAntipro/*.h"

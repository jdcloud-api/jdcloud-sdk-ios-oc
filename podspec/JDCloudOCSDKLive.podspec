...
s.name         = "JDCloudOCSDKLive"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Live"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Live framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKLive", "JDCloudOCSDKLive/**/*.{h,m}"


s.public_header_files = "JDCloudSDKLive/*.h"

...
s.name         = "JDCloudOCSDKIotcloudgateway"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Iotcloudgateway"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Iotcloudgateway framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKIotcloudgateway", "JDCloudOCSDKIotcloudgateway/**/*.{h,m}"


s.public_header_files = "JDCloudSDKIotcloudgateway/*.h"

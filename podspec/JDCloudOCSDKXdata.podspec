...
s.name         = "JDCloudOCSDKXdata"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Xdata"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Xdata framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKXdata", "JDCloudOCSDKXdata/**/*.{h,m}"


s.public_header_files = "JDCloudSDKXdata/*.h"

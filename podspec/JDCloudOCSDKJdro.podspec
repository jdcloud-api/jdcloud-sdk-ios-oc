...
s.name         = "JDCloudOCSDKJdro"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Jdro"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Jdro framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKJdro", "JDCloudOCSDKJdro/**/*.{h,m}"


s.public_header_files = "JDCloudSDKJdro/*.h"

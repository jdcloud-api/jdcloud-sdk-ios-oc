...
s.name         = "JDCloudOCSDKVod"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Vod"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Vod framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKVod", "JDCloudOCSDKVod/**/*.{h,m}"


s.public_header_files = "JDCloudSDKVod/*.h"

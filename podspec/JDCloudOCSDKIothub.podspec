...
s.name         = "JDCloudOCSDKIothub"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Iothub"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Iothub framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKIothub", "JDCloudOCSDKIothub/**/*.{h,m}"


s.public_header_files = "JDCloudSDKIothub/*.h"

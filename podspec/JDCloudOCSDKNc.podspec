...
s.name         = "JDCloudOCSDKNc"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Nc"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Nc framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKNc", "JDCloudOCSDKNc/**/*.{h,m}"


s.public_header_files = "JDCloudSDKNc/*.h"

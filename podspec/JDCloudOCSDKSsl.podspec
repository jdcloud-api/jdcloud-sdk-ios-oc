...
s.name         = "JDCloudOCSDKSsl"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Ssl"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Ssl framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKSsl", "JDCloudOCSDKSsl/**/*.{h,m}"


s.public_header_files = "JDCloudSDKSsl/*.h"

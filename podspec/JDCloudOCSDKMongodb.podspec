...
s.name         = "JDCloudOCSDKMongodb"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Mongodb"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Mongodb framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKMongodb", "JDCloudOCSDKMongodb/**/*.{h,m}"


s.public_header_files = "JDCloudSDKMongodb/*.h"

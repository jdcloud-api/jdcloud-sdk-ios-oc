...
s.name         = "JDCloudOCSDKJdw"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Jdw"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Jdw framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKJdw", "JDCloudOCSDKJdw/**/*.{h,m}"


s.public_header_files = "JDCloudSDKJdw/*.h"

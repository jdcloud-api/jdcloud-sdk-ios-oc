...
s.name         = "JDCloudOCSDKRds"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Rds"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Rds framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKRds", "JDCloudOCSDKRds/**/*.{h,m}"


s.public_header_files = "JDCloudSDKRds/*.h"

...
s.name         = "JDCloudOCSDKZfs"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Zfs"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Zfs framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKZfs", "JDCloudOCSDKZfs/**/*.{h,m}"


s.public_header_files = "JDCloudSDKZfs/*.h"

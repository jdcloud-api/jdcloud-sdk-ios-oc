...
s.name         = "JDCloudOCSDKOss"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Oss"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Oss framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKOss", "JDCloudOCSDKOss/**/*.{h,m}"


s.public_header_files = "JDCloudSDKOss/*.h"

...
s.name         = "JDCloudOCSDKDisk"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Disk"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Disk framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKDisk", "JDCloudOCSDKDisk/**/*.{h,m}"


s.public_header_files = "JDCloudSDKDisk/*.h"

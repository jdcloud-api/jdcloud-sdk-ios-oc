...
s.name         = "JDCloudOCSDKIam"
s.version      = "0.0.2"
s.summary      = "JDCloud Open API Objective-C SDK Iam"

s.description  = <<-DESC
JDCloud Open API Objective-C SDK Iam framework
DESC
...
s.source_files  = "Sources/JDCloudOCSDKIam", "JDCloudOCSDKIam/**/*.{h,m}"


s.public_header_files = "JDCloudSDKIam/*.h"
